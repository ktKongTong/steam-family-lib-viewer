...
export default function Home() {
  ...
  return (
    <main className="min-h-screen mx-auto px-4 py-8 sm:py-16">
      ...
      {
        playerStats && playerCommunityStats && type === 'account-v1' && (
          <div className="flex flex-col items-center">
            <div className="receipt-container">
              <div className="coffee-stain"/>
              <AccountReceipt playerStats={playerStats} communityStats={playerCommunityStats}
                              playerSummary={playerSummary} ref={receiptRef}/>
            </div>
