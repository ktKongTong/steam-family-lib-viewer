...
/**
 * Contains possible result codes. This is a very large enum that is used throughout Steam, so most values in this enum won't be relevant when authenticating.
 */
enum EResult {
  Invalid = 0,
  OK = 1,
